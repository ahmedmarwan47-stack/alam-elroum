/**
 * Countries for the lead form's dial-code and nationality pickers: ISO 3166
 * code, English name and international dialling prefix. Sorted by name.
 */
...
export const COUNTRIES: Country[] = [
  ...
  { code: "MO", name: "Macao SAR China", dial: "+853" },
...
/** Listed first in both pickers — the markets the sales team expects most. */
export const PRIORITY_CODES = ["EG", "QA", "SA", "AE", "KW", "BH", "OM"];

/** Emoji flag from an ISO code: each letter maps to a regional indicator. */
